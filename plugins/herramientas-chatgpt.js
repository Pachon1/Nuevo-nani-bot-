...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  if (!text) throw `*[❗] REALICE UNA CONSULTA, EJEMPLO:*\n\n*${usedPrefix + command}* Recomienda un top 10 de películas de acción\n*${usedPrefix + command}* Explica que es una ecuación de tercer grado y realiza un ejemplo simple y otro compuesto`;
  try {
...
handler.command = /^(openai|chatgpt|ia|robot|openai2|chatgpt2|ia2|robot2|PolvoraBot)$/i;
